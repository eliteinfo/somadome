...
function customConfirm(options) {
    ...
    this.render = function (dialog, callback) {
        ...
        confirmBox.getElementsByClassName("customalert_footer")[0].innerHTML = "<button class=\"btn btn-success customalert_button_confirm\" onclick=\"window.customConfirm.ok()\">" + (this.options.yes) + "</button>";
        document.getElementsByTagName("html")[0].style.overflow = "hidden";
