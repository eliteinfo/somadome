...
$sql_member = "select u.*,c.Name from tbl_users as u LEFT JOIN tbl_country as c  ON  c.Id=u.Country where u.Id = '".$_GET['id']."' AND u.User_type='0'";
...
<div class="row-fluid">
  <div class="span12"> 
    ...
    <ul class="breadcrumb">
      ...
      <li> <a href="buyer_list.php">List Users</a> <span class="icon-angle-right"></span> </li>
                    ...
                    <div class="span9">
                        <div class="row-fluid">
                            <div class="span8 profile-info">
                                ...
                                <p><?php echo stripslashes($db_member[0]['description']); ?></p>
                                ...
                                <ul class="unstyled inline">
                                    ...
                                    <?php /*<li><i class="icon-star"></i> Avrage Rating</li>
                            ...
                            <div class="span4">
                                <div class="portlet sale-summary">
                                    ...
                                    <div class="portlet-body">
                                        <ul class="unstyled">
                                            <li>
                            <span class="sale-info">CURRENT MONTH POST<?php /*<i class="icon-img-up"></i> */?></span>
                            <span class="sale-num"><?php 
							$sel_mpost = $objData->getAll("SELECT COUNT(*) as cnt FROM tbl_post WHERE uid=".$_REQUEST['id']." AND MONTH(created_date)=MONTH(CURRENT_DATE())");
                            echo $sel_mpost[0]['cnt']; ?></span>
                                            </li>
                                            <li>
                                                <span class="sale-info">TOTAL POST <?php /*<i class="icon-img-down"></i>*/ ?></span> 
                                                <span class="sale-num"><?php 
                            $sel_mpost = $objData->getAll("SELECT COUNT(*) as cnt1 FROM tbl_post WHERE uid=".$_REQUEST['id']." ");
                        ...
                        <div class="tabbable tabbable-custom tabbable-custom-profile">
                            <ul class="nav nav-tabs">
                            <?php 
							$sqlpost="select *,CASE status WHEN '1' THEN 'Approved' ELSE 'Not Approve' END AS  sts from tbl_post WHERE uid=".$_REQUEST['id']." order by id DESC LIMIT 5 ";
							$ans_post=$objModule->getAll($sqlpost);
							/*?>
                                <li class="active"><a href="#tab_1_11" data-toggle="tab">Total <?php echo count($ans_post);  ?> Post</a></li>
                               <?php *//* ?> <li ><a href="#tab_1_22" data-toggle="tab">Feeds</a></li><?php */ ?>
                               <li class="active"><a href="#tab_1_11" data-toggle="tab">Latest Post</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_11">
                                    <div class="portlet-body" style="display: block;">
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            ...
                                            <th class="hidden-phone"><i class="icon-question-sign"></i> Winning Status</th>
											...
											?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $vpost['price']; ?>$ <?php /*<span class="label label-success label-mini">Paid</span> */ ?></td>
                ...
                <div class="tab-pane profile-classic row-fluid" id="tab_1_2">
                   <?php /* ?> <div class="span2"><img src="assets/img/profile/profile-img.png" alt="" /> <a href="javascript:;" class="profile-edit">edit</a></div><?php */ ?>
                    <ul class="unstyled span10">
                        ...
                        <?php /*<li><span>Birthday:</span> <?php if($db_member[0]['Creation_date'] != ""): echo date("d M Y",strtotime($db_member[0]['Creation_date']));  else: echo "----"; endif; ?></li> */ ?>
...
$sel_bids = $objData->getAll("SELECT Count(Id) as cid  FROM tbl_bidding WHERE Post_id=".$valps['id']."");
                ...
                <div class="tab-pane" id="tab_1_5">
                    <?php 
						$sel_post = $objData->getAll("SELECT r.*,u.fname,u.lname,p.title FROM tbl_reviews AS r INNER JOIN tbl_users AS u ON u.Id=r.review_from INNER JOIN tbl_post AS p ON r.review_post=p.id  WHERE r.review_to=".$_REQUEST['id']." ");
                    ...
                    <div class="row-fluid portfolio-block">
                        <div class="span5 portfolio-text">
                  		...
                  		<div class="span5" style="overflow:hidden;width:50%;">
                            <div class="portfolio-info">
                            Project Title 
                                <span><?php echo $valps['title']; ?></span>
                            </div>
                            <div class="portfolio-info">
                                Rating
                                <span><?php 
//$sel_bids = $objData->getAll("SELECT Count(Id) as cid  FROM tbl_bidding WHERE Post_id=".$valps['id']."");
								//echo $sel_bids[0]['cid']; 
									$ratings =0;
								     ...
								     echo $finalratings = round($ratings / $count,2);
									 /* if (strpos( $finalratings, '.' ) === 1 )
									 			$flag=1;
									 else
									 			$flag=0;		
									 if($finalratings >0) 
