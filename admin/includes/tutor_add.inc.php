<?php
$sql="select * from tbl_bidding where Uid = '".$_GET['id']."' ";
...
if($_GET['did'] != '')
{
	...
	echo "<script> window.location.href = 'tutor_list.php' </script>";	
}
...
$sql_member = "select * from tbl_users where Id = '".$_GET['id']."' AND User_type='1'";
...
<div class="tabbable tabbable-custom boxless">
  ...
  <ul class="nav nav-tabs">
    ...
    <li><a href="#tab_2" data-toggle="tab">Bids</a></li>
    <?php  } ?>
    <?php /*if($db_member[0]['User_type'] == '1'){ ?>
				 ...
				 if($count1!=0) 
                  ...
                  <tr class="odd gradeX">
                    ...
                    <td><?php echo ($i+1);?></td>
					 ...
					 $selnm = $objData->getAll("SELECT * FROM tbl_post WHERE id =".$From_user."");
					 echo $selnm[0]['title'];
					  ?></td>
                    <td><?php echo $db_bidding[$i]['Bid_amt'];?></td>
                    <td><?php echo date('d M Y H:m:s',strtotime($db_bidding[$i]['create_at'])); ?></td>
                  </tr>
                  <?php }	
							}
							else
              ...
              <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                ...
                <tbody>
                  ...
                  <?php }		
					...
					{ ?>
                  <tr >
                    <Td colspan=5>No Bidding for this User </Td></tr>
                    <?php }
							?>
