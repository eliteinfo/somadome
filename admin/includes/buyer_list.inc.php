...
if(isset($_GET['status']) && $_GET['status'] == '1'){
   $member = "select * from tbl_users WHERE Status=1 AND User_type='0'";
}else if (isset($_GET['status']) && $_GET['status'] == '0') {
   $member = "select * from tbl_users WHERE Status=0 AND User_type='0'";
}else{
   $member = "select * from tbl_users WHERE User_type='0'";
}
            ...
            <div class="span12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-globe"></i>List Buyers</div>
                    </div>
                            ...
                            <tbody>
                             <?php  for($i=0;$i<count($db_member);$i++)
							 {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <?php /* ?><td width="80px"><a href="buyer_add.php?id=<?php echo $db_member[$i]['Id']; ?>" class="btn mini purple"><i class="icon-edit"></i>Manage</a></td> <?php */ ?>
                                    <td width="80px"><a href="view_users.php?id=<?php echo $db_member[$i]['Id']; ?>" class="btn mini green"><i class="icon-edit"></i>Detail</a></td>                                        
                                </tr>
                                <? }?>                              
                            </tbody>
                            <?php }
...
function doYouWantToActive(id,uid){
	...
	if(id == 1){
		...
		if(doIt){
			...
			window.location.href = 'buyer_list.php?sid='+id+'&uid='+uid;
