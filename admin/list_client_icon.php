...
<head>
	<meta charset="utf-8" />
    <title>Client | <?php echo $_SESSION['site_name']; ?></title>
	<meta content="width=device-width, initial-scale=1.0" name="viewport" />
	<meta content="" name="description" />
	<meta content="" name="author" />
	<!-- BEGIN GLOBAL MANDATORY STYLES -->
	<link rel="icon" href="http://acoreglobal.com/favicon/default/favicon.ico" type="image/x-icon" />
...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
		...
		<!-- END SIDEBAR -->
		<!-- BEGIN PAGE -->  
		<?php include('includes/list_client_icon.inc.php'); ?>
		<!-- END PAGE -->  
	</div>
	<!-- END CONTAINER -->
	<!-- BEGIN FOOTER -->
